...
//     if (document.readyState === 'complete') {
    ...
    tHeader
      .to('#loader', { duration: 0, display: 'none', ease: "none" })
  ...
  .to('.header__paralaxColor', { duration: 0, filter: 'grayscale(0%)', '-webkit-filter':'grayscale(0%)', ease: "none" }, 'head')
  ...
  .to('.header__paralaxBlack', { duration: 0, display: 'none', ease: "none", onComplete: islandAnimation }, '+=0.2')


  let tHeader1 = gsap.timeline({ repeat: -1, repeatDelay: -0.5})
  ...
  function bigBeeShake() {
      ...
      t3
      .to('.big_bee', { duration: 0.3, marginBottom: '15px', yoyo: true, repeat: -1, opacity: 1, ease: 'power1.out' })
  }
  ...
  function smallBeeShake() {
      var t3 = gsap.timeline({ });
      t3
      .to('.small_bee', { duration: 0.3, marginBottom: '10px', yoyo: true, repeat: -1, opacity: 1, ease: 'power1.out' })
  }



  function cloudAnimation() {
    let tHeader2 = gsap.timeline({repeat: -1, repeatDelay: -0.01})
    tHeader2
    .to('#cloud', { duration: 20, x: '100%', opacity: 1, ease: "none" })
    .to('#cloud', { duration: 0, opacity: 0, ease: "none" })
    .to('#cloud', { duration: 0, x: '-100%', opacity: 0, ease: "none" })
    .to('#cloud', { duration: 0, x: '-100%', opacity: 1, ease: "none" })
    .to('#cloud', { duration: 20, x: '0%', opacity: 1, ease: "none" })
  }
...
var displayScroll = gsap.timeline({
  scrollTrigger: {
    trigger: ".displayAd",
    start: "top center",
    end: "top center",
...
.to(".displayScrollCircleTop", { duration: 0.2, opacity: 1, y: 0, ease: 'power3.out'})
.to(".displayScrollCircleTop", { duration: 0.6, height: 150, opacity: 1, y: 20, ease: 'power3.out'})

.add('scb', '-=0.1')
.to(".displayScrollCircleTop", { duration: 0, opacity: 0, display: 'none', y: 0, ease: 'none'}, 'scb')
.to(".displayScrollCircleBottom", { duration: 0, opacity: 1, ease: 'none'}, 'scb')
.to(".displayScrollCircleBottom", { duration: 0.6, height: 13, y: 10, ease: 'power3.out'}, '-=0.1')
.to(".displayScrollCircleBottom", { duration: 0, opacity: 0, ease: 'none'}, '-=0.2')
...
var dynamicScroll = gsap.timeline({
  scrollTrigger: {
    trigger: ".dynamicAd",
    start: "top center",
    end: "top center",
...
.to(".dynamicScrollCircleTop", { duration: 0.2, opacity: 1, y: 0, ease: 'power3.out'})
.to(".dynamicScrollCircleTop", { duration: 0.6, height: 150, opacity: 1, y: 20, ease: 'power3.out'})

.add('scb', '-=0.1')
.to(".dynamicScrollCircleTop", { duration: 0, opacity: 0, display: 'none', y: 0, ease: 'none'}, 'scb')
.to(".dynamicScrollCircleBottom", { duration: 0, opacity: 1, ease: 'none'}, 'scb')
.to(".dynamicScrollCircleBottom", { duration: 0.6, height: 13, y: 10, ease: 'power3.out'}, '-=0.1')
.to(".dynamicScrollCircleBottom", { duration: 0, opacity: 0, ease: 'none'}, '-=0.2')
...
var weboramaScroll = gsap.timeline({
  scrollTrigger: {
    trigger: ".weboramaAd",
    start: "top center",
    end: "top center",
...
.to(".weboramaScrollCircleTop", { duration: 0.2, opacity: 1, y: 0, ease: 'power3.out'})
.to(".weboramaScrollCircleTop", { duration: 0.6, height: 150, opacity: 1, y: 20, ease: 'power3.out'})

.add('scb', '-=0.1')
.to(".weboramaScrollCircleTop", { duration: 0, opacity: 0, display: 'none', y: 0, ease: 'none'}, 'scb')
.to(".weboramaScrollCircleBottom", { duration: 0, opacity: 1, ease: 'none'}, 'scb')
.to(".weboramaScrollCircleBottom", { duration: 0.6, height: 13, y: 10, ease: 'power3.out'}, '-=0.1')
.to(".weboramaScrollCircleBottom", { duration: 0, opacity: 0, ease: 'none'}, '-=0.2')
...
var shadowScroll = gsap.timeline({
  scrollTrigger: {
    trigger: ".shadowAd",
    start: "top center",
    end: "top center",
...
.to(".shadowScrollCircleTop", { duration: 0.2, opacity: 1, y: 0, ease: 'power3.out'})
.to(".shadowScrollCircleTop", { duration: 0.6, height: 150, opacity: 1, y: 20, ease: 'power3.out'})

.add('scb', '-=0.1')
.to(".shadowScrollCircleTop", { duration: 0, opacity: 0, display: 'none', y: 0, ease: 'none'}, 'scb')
.to(".shadowScrollCircleBottom", { duration: 0, opacity: 1, ease: 'none'}, 'scb')
.to(".shadowScrollCircleBottom", { duration: 0.6, height: 13, y: 10, ease: 'power3.out'}, '-=0.1')
.to(".shadowScrollCircleBottom", { duration: 0, opacity: 0, ease: 'none'}, '-=0.2')
